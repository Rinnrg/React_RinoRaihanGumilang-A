...
export default function ProductDetail() {
  ...
  if (!product) {
    return (
      <>
        <h1 className="flex w-full h-full text-center items-center justify-center text-4xl text-pink-600">PRODUK TIDAK ADA.</h1>
      </>
    );
  }
  return (
    <>
      ...
      <div className="flex gap-[30px] px-24">
        ...
        <div className="flex flex-col gap-[20px]">
          ...
          {product.stock > 0 ? (
            product.stock <= 25 ? (
              <span className="font-medium text-yellow-500">Tersedia, Stok hampir habis</span>
            ) : (
          ...
          {product.stock > 0 ? (
            <div>
              ...
              >
                ...
                />
                <span className="text-white">Masukkan Keranjang</span>
              </Button>
            </div>
          ) : (
            <div>
